...
In its most basic form, how can a recommender system recommend? 
...
\mynote[author=Harrie]{(Kleinigheid) Introduceer alleen notatie: $R(u, i)$, als je het later ook vaak gaat gebruiken of in formules gebruikt. Hier voegt het niet zo veel toe en kun je het in alleen Engels uitleggen. }
...
\mynote[author=Harrie]{Bij afkorting gebruik je hoofdletters voor de duidelijkheid, bijv.: Appelachtige Bananen Citroen (ABC) en niet appelachtige bananen citroen (ABC).}
...
\mynote[author=Harrie]{Het zou goed zijn als je de onderwerpen terug kan koppelen aan job recommendation in een paar zinnen, vooral bij privacy by design and the cold start problem.
Het is waarschijnlijk wel duidelijk dat privacy belangrijk is bij werkzoekenden, alsnog in een of twee zinnen op het einde of begin van de alinea zorg je dat niemand het kan missen.}
