...
The outcomes of the previous mentioned models can be used for two types of recommendation: 1) the prediction of the utility of a certain job to a user, or 2) a list of the top-\textit{n} useful jobs for a user.
