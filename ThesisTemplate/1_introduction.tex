...
Today the application of job recommender systems is mostly restricted to online platforms. 
...
\mynote[author=Harrie]{'with a distance to the labor market' klinkt niet helemaal soepel}
...
\mynote[author=Harrie]{Geef de research questions wat opmaak om ze uit de tekst te laten springen, bijvoorbeeld door itemize te gebruiken. (Zowel de hoofdvraag als de subquestions.)}
%RQ
...
\mynote[author=Harrie]{
Deze zou ik inkorten en het niet specifiek over Amsterdam hebben:
To what extent can a recommender system based on content-based filtering match job openings to welfare beneficiaries in a similar (or better) way as the customer managers of the municipality of Amsterdam?
 ->
Can a content-based recommender system based on match job openings to welfare beneficiaries comparable to human customer managers?
}
\mynote[author=Harrie]{
Ook deze zou ik inkorten:
Does the implementationof different pre-processing, feature selection methods, and a hybrid recommender system have a significant effect on theprediction accuracy?
 ->
Does pre-processing, feature selection, and model choice have a significant effect on recommender performance?
}
