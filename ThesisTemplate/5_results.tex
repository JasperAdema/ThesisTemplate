...
Analyzing the user features that the RFECV method retained it was found that based on heuristics 64\% can be classified as traits that hinder a person from getting a job.
