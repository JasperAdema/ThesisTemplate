...
\fancyfoot{}
%Move the page numbering to the bottom
\pagestyle{plain}

\usepackage{multirow}

\newcommand{\shorttitle}{Job Recommender Systems for Welfare Beneficiaries} % Put your short title here
...
\twocolumn[{%
 \centering
 \textbf{\LARGE Job Recommender Systems for Welfare Beneficiaries}\\[.5em]
 \large Jasper Adema\\
 \normalsize University of Amsterdam \\ [.5em]
}]
